...
pub mod transformation {
    ...
    impl<T: Float> Default for Transformation<T> {
        ...
        /// ### Example
        /// ```rust
        /// use vector::{transformation::Transformation, Matrix};
        ///
    ...
    impl<T: Float> From<&(Screw<T>, T)> for Transformation<T> {
        ...
        /// ```rust
        /// use vector::{transformation::{Transformation, Screw}, Matrix};
        ///
        /// let screw = Screw::new(
        ///     Matrix::from([[0.], [1.], [0.]]),
    ...
    impl<T: Float> From<Matrix<6, 1, T>> for Twist<T> {
        ...
        /// ```rust
        /// use vector::{Matrix, transformation::Twist};
        ///
        /// let mat = Matrix::from([
        ///     [12.],
        ///     [1.],
    ...
    /// ```rust
    /// use vector::{Matrix, transformation::{Transformation, Screw, forward_kinematice_in_body_frame}};
    ...
    /// ```rust
    /// use vector::{Matrix, transformation::{Transformation, Screw, forward_kinematice_in_space_frame}};
    /// use core::f32::consts::PI;
    ///
    /// let m = Transformation::try_from(Matrix::from([
    ///     [-1., 0., 0., 0.425 + 0.392],
